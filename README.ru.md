...
![Развёрнутая панель](docs/images/panel.png)
...
Развёрнутый до конца, виджет хранит историю того, что читает:

![Полная статистика с графиками истории](docs/images/full.png)
